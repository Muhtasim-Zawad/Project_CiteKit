				...
				<section className="bg-background pb-16 pt-16 md:pb-32">
					<div className="group relative m-auto max-w-5xl px-6">
						...
						<div className="group-hover:blur-xs mx-auto mt-12 grid max-w-2xl grid-cols-4 gap-x-12 gap-y-8 transition-all duration-500 group-hover:opacity-50 sm:gap-x-16 sm:gap-y-14">
							{[
								{ src: "nvidia.svg", alt: "Nvidia", h: "h-5" },
								{ src: "column.svg", alt: "Column", h: "h-4" },
								{ src: "github.svg", alt: "GitHub", h: "h-4" },
								{ src: "nike.svg", alt: "Nike", h: "h-5" },
								{ src: "lemonsqueezy.svg", alt: "Lemon Squeezy", h: "h-5" },
								{ src: "laravel.svg", alt: "Laravel", h: "h-4" },
								{ src: "lilly.svg", alt: "Lilly", h: "h-7" },
								{ src: "openai.svg", alt: "OpenAI", h: "h-6" },
							].map((logo, idx) => (
